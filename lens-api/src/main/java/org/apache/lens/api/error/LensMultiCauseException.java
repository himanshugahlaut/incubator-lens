...
public class LensMultiCauseException extends LensException {
  ...
  public LensMultiCauseException(final ImmutableList<LensException> causes) {
    this(INTERNAL_SERVER_ERROR.getValue(), causes);
  }

  public LensMultiCauseException(final LensException... causes) {
    this(INTERNAL_SERVER_ERROR.getValue(), causes);
  }

  public LensMultiCauseException(final int errorCode, @NonNull final ImmutableList<LensException> causes) {
  ...
  public LensMultiCauseException(final int errorCode, final LensException... causes) {
    this(errorCode, ImmutableList.copyOf(causes));
  }
